...
public class playerMovementEnding : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        FindObjectOfType<AudioManager>().Play("EmptyAir");
    }
    ...
    private void Update()
    {
     ...
     /*   Debug.DrawRay(stepRayUpper.transform.position, stepRayUpper.transform.forward);
        Debug.DrawRay(stepRayLower.transform.position, stepRayLower.transform.forward);*/
    }
